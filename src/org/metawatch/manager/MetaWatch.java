...
public class MetaWatch extends Activity {
	...
	static void logDebug(String message) {
		//if(Log.isLoggable(MetaWatch.TAG, Log.DEBUG)) {
		Log.d(MetaWatch.TAG, message);
		//}
	}

	static void logInfo(String message) {
		if(Log.isLoggable(MetaWatch.TAG, Log.INFO)) {
			Log.i(MetaWatch.TAG, message);
		}
	}

	static void logVerbose(String message) {
		if(Log.isLoggable(MetaWatch.TAG, Log.VERBOSE)) {
			Log.v(MetaWatch.TAG, message);
		}
	}

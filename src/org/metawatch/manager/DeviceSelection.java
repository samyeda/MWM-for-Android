	...
	class Receiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(BluetoothAdapter.ACTION_DISCOVERY_FINISHED)) {
				MetaWatch.logDebug("discovery finished");
			...
			if (intent.getAction().equals(BluetoothDevice.ACTION_FOUND)) {
				...
				MetaWatch.logDebug("device found name: " +device.getName() +" class: " +device.getBluetoothClass().getMajorDeviceClass());
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				MetaWatch.logDebug("device selected: " + arg2);

				Map<String, String> map = list.get(arg2);
				String mac = map.get("mac");

				MetaWatch.logDebug("mac selected: " + mac);
